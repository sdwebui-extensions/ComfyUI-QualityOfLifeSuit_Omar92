    ...
    def INPUT_TYPES(cls):
        return {"required": {},
                "optional": {
                    ...
                    "text6": ("STRING", {"multiline": False, "default": "",  "defaultBehavior": "input"}),
                    "text7": ("STRING", {"multiline": False, "default": "",  "defaultBehavior": "input"}),
                    "text8": ("STRING", {"multiline": False, "default": "",  "defaultBehavior": "input"}),
                    "text9": ("STRING", {"multiline": False, "default": "",  "defaultBehavior": "input"}),
                    "text10": ("STRING", {"multiline": False, "default": "",  "defaultBehavior": "input"}),
                    "text11": ("STRING", {"multiline": False, "default": "",  "defaultBehavior": "input"}),
                    "text12": ("STRING", {"multiline": False, "default": "",  "defaultBehavior": "input"}),
                    "text13": ("STRING", {"multiline": False, "default": "",  "defaultBehavior": "input"}),
                    "separator": ("STRING", {"multiline": False, "default": ","}),
                }}
